...
class Telcom extends CRMEntity {
    ...
    private function providerInfoInsertion() {
        ...
        $db->pquery("INSERT INTO " . Settings_Telcom_Record_Model::defaultProvideTable . " values(?)", array(ProvidersEnum::TELCOM));
        $db->pquery("INSERT INTO " . Settings_Telcom_Record_Model::optionsTable . " VALUES('use_click_to_call', '0')", array());
    }
